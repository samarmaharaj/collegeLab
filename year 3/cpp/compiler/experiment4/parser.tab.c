...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "NUM", "ADD",
  "MUL", "LPAREN", "RPAREN", "$accept", "program", "E", "T", "F", YY_NULLPTR
};
...
yyreduce:
  ...
  case 2: /* program: E  */
#line 36 "parser.y"
      { root = (yyvsp[0].nval); printf("Parsing successful. String belongs to the grammar.\n"); }
#line 1081 "parser.tab.c"
    break;

  case 3: /* E: E ADD T  */
#line 40 "parser.y"
            { (yyval.nval) = create_node("+", (yyvsp[-2].nval), (yyvsp[0].nval)); }
...
#line 1111 "parser.tab.c"
  ...
  case 8: /* F: ID  */
#line 51 "parser.y"
                     { (yyval.nval) = create_node((yyvsp[0].sval), NULL, NULL); }
