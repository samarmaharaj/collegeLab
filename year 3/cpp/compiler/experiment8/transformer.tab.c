...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NON_TERMINAL = 3,               /* NON_TERMINAL  */
  YYSYMBOL_TERMINAL = 4,                   /* TERMINAL  */
  YYSYMBOL_ARROW = 5,                      /* ARROW  */
  YYSYMBOL_PIPE = 6,                       /* PIPE  */
  YYSYMBOL_SEMICOLON = 7,                  /* SEMICOLON  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_grammar_input = 9,              /* grammar_input  */
  YYSYMBOL_rules = 10,                     /* rules  */
  YYSYMBOL_rule = 11,                      /* rule  */
  YYSYMBOL_productions = 12,               /* productions  */
  YYSYMBOL_production = 13,                /* production  */
  YYSYMBOL_symbol_sequence = 14,           /* symbol_sequence  */
...
{
       0,   234,   234,   242,   242,   245,   249,   256,   266,   270,
     271,   280,   280
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NON_TERMINAL",
  "TERMINAL", "ARROW", "PIPE", "SEMICOLON", "$accept", "grammar_input",
  "rules", "rule", "productions", "production", "symbol_sequence",
  "symbol", YY_NULLPTR
};
...
{
       7,     8,    13,    14,     3,     4,     6,    16,     0,    15
};

static const yytype_int8 yycheck[] =
{
       3,     4,     6,     7,     0,     3,     5,    13,    -1,    11
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* grammar_input: rules  */
#line 234 "transformer.y"
          {
...
#line 1294 "transformer.tab.c"
    break;

  case 5: /* rule: NON_TERMINAL ARROW productions SEMICOLON  */
#line 245 "transformer.y"
                                             { free((yyvsp[-3].str)); }
#line 1300 "transformer.tab.c"
    break;

  case 6: /* productions: production  */
#line 249 "transformer.y"
               {
        current_lhs_index = find_or_add_rule((yyvsp[-1].str)[0]);
        if(current_lhs_index != -1 && grammar[current_lhs_index].count < MAX_PRODUCTIONS) {
            strcpy(grammar[current_lhs_index].rhs[grammar[current_lhs_index].count++], (yyvsp[0].str));
        }
        free((yyvsp[0].str));
    }
#line 1312 "transformer.tab.c"
    break;

  case 7: /* productions: productions PIPE production  */
#line 256 "transformer.y"
                                  {
        if(current_lhs_index != -1 && grammar[current_lhs_index].count < MAX_PRODUCTIONS) {
            strcpy(grammar[current_lhs_index].rhs[grammar[current_lhs_index].count++], (yyvsp[0].str));
        }
...
#line 1323 "transformer.tab.c"
    break;

  case 8: /* production: symbol_sequence  */
#line 266 "transformer.y"
                    { (yyval.str) = (yyvsp[0].str); }
#line 1329 "transformer.tab.c"
    break;

  case 9: /* symbol_sequence: symbol  */
#line 270 "transformer.y"
           { (yyval.str) = (yyvsp[0].str); }
#line 1335 "transformer.tab.c"
    break;

  case 10: /* symbol_sequence: symbol_sequence symbol  */
#line 271 "transformer.y"
                             {
        char* temp = malloc(strlen((yyvsp[-1].str)) + strlen((yyvsp[0].str)) + 2); // space for null and char
        sprintf(temp, "%s%s", (yyvsp[-1].str), (yyvsp[0].str));
        (yyval.str) = temp;
        free((yyvsp[-1].str));
        free((yyvsp[0].str));
    }
#line 1347 "transformer.tab.c"
    break;

  case 11: /* symbol: NON_TERMINAL  */
#line 280 "transformer.y"
                     { (yyval.str) = (yyvsp[0].str); }
#line 1353 "transformer.tab.c"
    break;

  case 12: /* symbol: TERMINAL  */
#line 280 "transformer.y"
                                             { (yyval.str) = (yyvsp[0].str); }
#line 1359 "transformer.tab.c"
    break;


#line 1363 "transformer.tab.c"
