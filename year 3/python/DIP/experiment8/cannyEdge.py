...
img1_edges = canny_edge_detection(img1, 50, 75)
img2_edges = canny_edge_detection(img2, 50, 200)

# Page 1
show_page(img1, img1_edges, "House Image")

# Page 2
show_page(img2, img2_edges, "Brain Image")
